...
class CreateWhatsappQr extends StatefulWidget {
  const CreateWhatsappQr({super.key});

  @override
  State<CreateWhatsappQr> createState() => _CreateWhatsappQrState();
}

class _CreateWhatsappQrState extends State<CreateWhatsappQr> {
  ...
  void submitForm() {
    if (_formKey.currentState!.validate()) {
      String code = selectedCountryCode.replaceFirst("+", "");
      String phone = _phoneController.text;
      String message = _messageController.text;

      // Create QR CodeData
      String qrData = "https://wa.me/$code$phone?text=$message";
